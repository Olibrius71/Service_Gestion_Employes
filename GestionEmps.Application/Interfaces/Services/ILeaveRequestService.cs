...
public interface ILeaveRequestService
{
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. The task result contains the leave request details as a <c>LeaveRequestDto</c>.</returns>
    /// <exception cref="SGE.Core.Exceptions.LeaveRequestNotFoundException">Thrown when the leave request with the specified ID is not found.</exception>
