...
public interface IAttendanceService
{
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. The task result contains the attendance details for the specified ID.</returns>
    /// <exception cref="SGE.Core.Exceptions.AttendanceException">Thrown when the attendance record with the specified ID is not found.</exception>
    ...
    Task<IEnumerable<AttendanceDto>> GetAttendancesByEmployeeAsync(int employeeId, DateTime? startDate = null, DateTime? endDate = null, CancellationToken cancellationToken = default);
