...
/// Provides methods for employees to clock in and out, retrieve
/// attendance data, and calculate work hours.
/// </summary>
public interface IAttendanceService
{
    ...
    /// </summary>
    /// <param name="clockInDto">An object containing clock-in
    /// information such as employee ID, timestamp, and notes.</param>
    ...
    /// task result contains the attendance details after clock-in.</returns>
    ...
    /// </summary>
    /// <param name="clockOutDto">An object containing clock-out
    /// information such as employee ID, timestamp, and notes.</param>
    /// <param name="cancellationToken">A token to monitor for
    /// cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. The
    /// task result contains the attendance details after clock-out.</returns>
    ...
    /// details for the attendance record such as employee ID, date, clock-in
    /// time, clock-out time, break duration, and notes.</param>
    /// <param name="cancellationToken">A token to monitor for
    /// cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. The
    /// task result contains the details of the created attendance
    /// record.</returns>
    ...
    /// </summary>
    /// <param name="id">The unique identifier of the attendance
    /// record.</param>
    /// <param name="cancellationToken">A token to monitor for
    /// cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. The
    /// task result contains the attendance details for the specified ID, or
    ...
    /// <summary>
    /// Retrieves attendance records for a specific employee within a
    /// specified date range.
    /// </summary>
    /// <param name="employeeId">The unique identifier of the employee
    /// whose attendance records are to be retrieved.</param>
    /// <param name="startDate">The beginning of the date range for the
    /// attendance query. If null, no start date filter is applied.</param>
    /// <param name="endDate">The end of the date range for the
    /// attendance query. If null, no end date filter is applied.</param>
    /// <param name="cancellationToken">A token to monitor for
    /// cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. The
    /// task result contains an enumerable collection of attendance records
    /// matching the query parameters.</returns>
    ...
    /// <summary>
    /// Retrieves a collection of attendance records for all employees
    /// for a specific date.
    /// </summary>
    ...
    /// cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. The
    /// task result contains a collection of attendance details for the
    ...
    Task<decimal> GetMonthlyWorkedHoursAsync(int employeeId, int year,
        int month,
        CancellationToken cancellationToken = default);
}