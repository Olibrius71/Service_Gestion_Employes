...
public class LeaveRequestCreateDto
{
    ...
    /// <summary>
    /// Gets or sets the type of leave requested, represented as an
    /// enumeration (e.g., Annual, Sick, etc.).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the reason provided by the employee for the leave
    /// request.
    /// </summary>
