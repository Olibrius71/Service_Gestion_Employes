...
/// Provides endpoints for clocking in, clocking out, retrieving
/// attendance records, and calculating attendance-related data.
/// </summary>
[ApiController]
[Route("api/[controller]")]
public class AttendancesController(IAttendanceService attendanceService)
    : ControllerBase
{
    /// <summary>
    /// Records the clock-in time for an employee.
    /// </summary>
    /// <param name="clockInDto">The data transfer object containing
    /// clock-in details.</param>
    /// <param name="cancellationToken">A token to monitor for
    /// cancellation requests.</param>
    /// <returns>Returns the updated attendance details of the
    /// employee.</returns>
    [HttpPost("clock-in")]
    ...
    /// </summary>
    /// <param name="clockOutDto">The data transfer object containing
    /// clock-out details.</param>
    /// <param name="cancellationToken">A token to monitor for
    /// cancellation requests.</param>
    /// <returns>Returns the updated attendance details of the
    /// employee.</returns>
    ...
    /// </summary>
    /// <param name="createAttendanceDto">The data transfer object
    /// containing the details for the new attendance record.</param>
    /// <param name="cancellationToken">A token to cancel the
    /// asynchronous operation, if required.</param>
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            // Using Conflict (409) is appropriate for a resource creation issue like "record already exists"
    ...
    /// <param name="cancellationToken">A token to monitor for
    /// cancellation requests.</param>
    /// <returns>Returns the attendance details if found; otherwise, a
    ...
    /// <summary>
    /// Retrieves the attendance records of a specific employee within
    /// an optional date range.
    /// </summary>
    /// <param name="employeeId">The unique identifier of the
    /// employee.</param>
    /// <param name="startDate">The start date of the attendance query
    /// (optional).</param>
    /// <param name="endDate">The end date of the attendance query
    /// (optional).</param>
    /// <param name="cancellationToken">A token to monitor for
    /// cancellation requests.</param>
    /// <returns>Returns a collection of attendance records for the
    /// specified employee and date range.</returns>
    ...
    /// records.</param>
    /// <param name="cancellationToken">Token used to signal
    ...
    /// whose attendance is being retrieved.</param>
    /// <param name="cancellationToken">A cancellation token to cancel
    /// the operation if needed.</param>
    /// <returns>Returns the attendance details for the employee for the
    /// current day.</returns>
    ...
    /// <summary>
    /// Retrieves the total number of hours worked by an employee for a
    /// specific month and year.
    /// </summary>
    /// <param name="employeeId">The unique identifier of the
    /// employee.</param>
    /// <param name="year">The year for which the hours are being
    /// calculated.</param>
    /// <param name="month">The month for which the hours are being
    /// calculated.</param>
    /// <param name="cancellationToken">A token to monitor for
    /// cancellation requests.</param>
    /// <returns>Returns the total hours worked by the employee as a
